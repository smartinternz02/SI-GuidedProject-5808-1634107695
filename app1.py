...
API_KEY = "dOIIuUd-B3t4ZU1udVm_BOJn69JnZEoA2nWWVClOXXg0"
...
def predict():
     ...
     response_scoring = requests.post('https://us-south.ml.cloud.ibm.com/ml/v4/deployments/8a65c13c-f3d5-472b-8af2-785a79e1eb4a/predictions?version=2021-11-01', json=payload_scoring, headers={'Authorization': 'Bearer ' + mltoken})
